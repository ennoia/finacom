...
// Create page object
$fondeadorfactura_edit = new fondeadorfactura_edit();

// Run the page
$fondeadorfactura_edit->run();
...
$fondeadorfactura_edit->Page_Render();
?>
...
var ffondeadorfacturaedit = currentForm = new ew.Form("ffondeadorfacturaedit", "edit");

// Validate form
ffondeadorfacturaedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($fondeadorfactura_edit->idfondeadorfact->Required) { ?>
			elm = this.getElements("x" + infix + "_idfondeadorfact");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $fondeadorfactura->idfondeadorfact->caption(), $fondeadorfactura->idfondeadorfact->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($fondeadorfactura_edit->rfcfondeador->Required) { ?>
		...
		<?php } ?>
		<?php if ($fondeadorfactura_edit->rfcfactura->Required) { ?>
		...
		<?php } ?>
		<?php if ($fondeadorfactura_edit->porcentajedescuento->Required) { ?>
		...
		<?php if ($fondeadorfactura_edit->comprobante->Required) { ?>
		...
		<?php } ?>
		<?php if ($fondeadorfactura_edit->fecha_movimiento->Required) { ?>
		...
		<?php if ($fondeadorfactura_edit->fondeadorrfc->Required) { ?>
...
ffondeadorfacturaedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ffondeadorfacturaedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $fondeadorfactura_edit->showPageHeader(); ?>
<?php
$fondeadorfactura_edit->showMessage();
?>
<form name="ffondeadorfacturaedit" id="ffondeadorfacturaedit" class="<?php echo $fondeadorfactura_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($fondeadorfactura_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $fondeadorfactura_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="fondeadorfactura">
<input type="hidden" name="k_hash" id="k_hash" value="<?php echo $fondeadorfactura_edit->HashValue ?>">
<?php if ($fondeadorfactura->UpdateConflict == "U") { // Record already updated by other user ?>
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo (int)$fondeadorfactura_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($fondeadorfactura->idfondeadorfact->Visible) { // idfondeadorfact ?>
	<div id="r_idfondeadorfact" class="form-group row">
		<label id="elh_fondeadorfactura_idfondeadorfact" class="<?php echo $fondeadorfactura_edit->LeftColumnClass ?>"><?php echo $fondeadorfactura->idfondeadorfact->caption() ?><?php echo ($fondeadorfactura->idfondeadorfact->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeadorfactura_edit->RightColumnClass ?>"><div<?php echo $fondeadorfactura->idfondeadorfact->cellAttributes() ?>>
...
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($fondeadorfactura->idfondeadorfact->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="fondeadorfactura" data-field="x_idfondeadorfact" name="x_idfondeadorfact" id="x_idfondeadorfact" value="<?php echo HtmlEncode($fondeadorfactura->idfondeadorfact->CurrentValue) ?>">
<?php } else { ?>
<span id="el_fondeadorfactura_idfondeadorfact">
<span<?php echo $fondeadorfactura->idfondeadorfact->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($fondeadorfactura->idfondeadorfact->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="fondeadorfactura" data-field="x_idfondeadorfact" name="x_idfondeadorfact" id="x_idfondeadorfact" value="<?php echo HtmlEncode($fondeadorfactura->idfondeadorfact->FormValue) ?>">
<?php } ?>
<?php echo $fondeadorfactura->idfondeadorfact->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($fondeadorfactura->rfcfondeador->Visible) { // rfcfondeador ?>
	<div id="r_rfcfondeador" class="form-group row">
		<label id="elh_fondeadorfactura_rfcfondeador" for="x_rfcfondeador" class="<?php echo $fondeadorfactura_edit->LeftColumnClass ?>"><?php echo $fondeadorfactura->rfcfondeador->caption() ?><?php echo ($fondeadorfactura->rfcfondeador->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeadorfactura_edit->RightColumnClass ?>"><div<?php echo $fondeadorfactura->rfcfondeador->cellAttributes() ?>>
<?php if (!$fondeadorfactura->isConfirm()) { ?>
...
<?php if ($fondeadorfactura->rfcfactura->Visible) { // rfcfactura ?>
	<div id="r_rfcfactura" class="form-group row">
		<label id="elh_fondeadorfactura_rfcfactura" for="x_rfcfactura" class="<?php echo $fondeadorfactura_edit->LeftColumnClass ?>"><?php echo $fondeadorfactura->rfcfactura->caption() ?><?php echo ($fondeadorfactura->rfcfactura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeadorfactura_edit->RightColumnClass ?>"><div<?php echo $fondeadorfactura->rfcfactura->cellAttributes() ?>>
<?php if (!$fondeadorfactura->isConfirm()) { ?>
...
<?php if ($fondeadorfactura->porcentajedescuento->Visible) { // porcentajedescuento ?>
	<div id="r_porcentajedescuento" class="form-group row">
		<label id="elh_fondeadorfactura_porcentajedescuento" for="x_porcentajedescuento" class="<?php echo $fondeadorfactura_edit->LeftColumnClass ?>"><?php echo $fondeadorfactura->porcentajedescuento->caption() ?><?php echo ($fondeadorfactura->porcentajedescuento->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeadorfactura_edit->RightColumnClass ?>"><div<?php echo $fondeadorfactura->porcentajedescuento->cellAttributes() ?>>
<?php if (!$fondeadorfactura->isConfirm()) { ?>
...
<?php if ($fondeadorfactura->comprobante->Visible) { // comprobante ?>
	<div id="r_comprobante" class="form-group row">
		<label id="elh_fondeadorfactura_comprobante" class="<?php echo $fondeadorfactura_edit->LeftColumnClass ?>"><?php echo $fondeadorfactura->comprobante->caption() ?><?php echo ($fondeadorfactura->comprobante->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeadorfactura_edit->RightColumnClass ?>"><div<?php echo $fondeadorfactura->comprobante->cellAttributes() ?>>
...
<?php if (Post("fa_x_comprobante") == "0") { ?>
<input type="hidden" name="fa_x_comprobante" id= "fa_x_comprobante" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_comprobante" id= "fa_x_comprobante" value="1">
<?php } ?>
...
<?php if ($fondeadorfactura->fecha_movimiento->Visible) { // fecha_movimiento ?>
	<div id="r_fecha_movimiento" class="form-group row">
		<label id="elh_fondeadorfactura_fecha_movimiento" for="x_fecha_movimiento" class="<?php echo $fondeadorfactura_edit->LeftColumnClass ?>"><?php echo $fondeadorfactura->fecha_movimiento->caption() ?><?php echo ($fondeadorfactura->fecha_movimiento->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeadorfactura_edit->RightColumnClass ?>"><div<?php echo $fondeadorfactura->fecha_movimiento->cellAttributes() ?>>
<?php if (!$fondeadorfactura->isConfirm()) { ?>
...
<script>
ew.createDateTimePicker("ffondeadorfacturaedit", "x_fecha_movimiento", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
<?php } else { ?>
...
<?php if ($fondeadorfactura->fondeadorrfc->Visible) { // fondeadorrfc ?>
	<div id="r_fondeadorrfc" class="form-group row">
		<label id="elh_fondeadorfactura_fondeadorrfc" for="x_fondeadorrfc" class="<?php echo $fondeadorfactura_edit->LeftColumnClass ?>"><?php echo $fondeadorfactura->fondeadorrfc->caption() ?><?php echo ($fondeadorfactura->fondeadorrfc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeadorfactura_edit->RightColumnClass ?>"><div<?php echo $fondeadorfactura->fondeadorrfc->cellAttributes() ?>>
<?php if (!$fondeadorfactura->isConfirm()) { ?>
...
<?php if (!$fondeadorfactura_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $fondeadorfactura_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<?php if ($fondeadorfactura->UpdateConflict == "U") { // Record already updated by other user ?>
...
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $fondeadorfactura_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
...
<?php
$fondeadorfactura_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$fondeadorfactura_edit->terminate();
?>