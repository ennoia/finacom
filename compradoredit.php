...
// Create page object
$comprador_edit = new comprador_edit();
...
var fcompradoredit = currentForm = new ew.Form("fcompradoredit", "edit");

// Validate form
fcompradoredit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($comprador_edit->id_comprador->Required) { ?>
		...
		<?php if ($comprador_edit->razon_social->Required) { ?>
		...
		<?php } ?>
		<?php if ($comprador_edit->rfc->Required) { ?>
		...
		<?php } ?>
		<?php if ($comprador_edit->calle->Required) { ?>
		...
		<?php } ?>
		<?php if ($comprador_edit->colonia->Required) { ?>
		...
		<?php } ?>
		<?php if ($comprador_edit->codpostal->Required) { ?>
		...
		<?php if ($comprador_edit->ciudad->Required) { ?>
		...
		<?php } ?>
		<?php if ($comprador_edit->telefono->Required) { ?>
		...
		<?php } ?>
		<?php if ($comprador_edit->correo->Required) { ?>
		...
		<?php } ?>
		<?php if ($comprador_edit->pymerfc->Required) { ?>
...
fcompradoredit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcompradoredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcompradoredit.lists["x_pymerfc"] = <?php echo $comprador_edit->pymerfc->Lookup->toClientList() ?>;
fcompradoredit.lists["x_pymerfc"].options = <?php echo JsonEncode($comprador_edit->pymerfc->lookupOptions()) ?>;
fcompradoredit.autoSuggests["x_pymerfc"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php $comprador_edit->showPageHeader(); ?>
<?php
$comprador_edit->showMessage();
?>
<form name="fcompradoredit" id="fcompradoredit" class="<?php echo $comprador_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($comprador_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $comprador_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="comprador">
<input type="hidden" name="k_hash" id="k_hash" value="<?php echo $comprador_edit->HashValue ?>">
<?php if ($comprador->UpdateConflict == "U") { // Record already updated by other user ?>
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo (int)$comprador_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($comprador->id_comprador->Visible) { // id_comprador ?>
	<div id="r_id_comprador" class="form-group row">
		<label id="elh_comprador_id_comprador" for="x_id_comprador" class="<?php echo $comprador_edit->LeftColumnClass ?>"><?php echo $comprador->id_comprador->caption() ?><?php echo ($comprador->id_comprador->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comprador_edit->RightColumnClass ?>"><div<?php echo $comprador->id_comprador->cellAttributes() ?>>
<?php if (!$comprador->isConfirm()) { ?>
<span id="el_comprador_id_comprador">
<span<?php echo $comprador->id_comprador->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($comprador->id_comprador->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="comprador" data-field="x_id_comprador" name="x_id_comprador" id="x_id_comprador" value="<?php echo HtmlEncode($comprador->id_comprador->CurrentValue) ?>">
<?php } else { ?>
<span id="el_comprador_id_comprador">
<span<?php echo $comprador->id_comprador->viewAttributes() ?>>
...
<?php if ($comprador->razon_social->Visible) { // razon_social ?>
	<div id="r_razon_social" class="form-group row">
		<label id="elh_comprador_razon_social" for="x_razon_social" class="<?php echo $comprador_edit->LeftColumnClass ?>"><?php echo $comprador->razon_social->caption() ?><?php echo ($comprador->razon_social->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comprador_edit->RightColumnClass ?>"><div<?php echo $comprador->razon_social->cellAttributes() ?>>
<?php if (!$comprador->isConfirm()) { ?>
...
<?php if ($comprador->rfc->Visible) { // rfc ?>
	<div id="r_rfc" class="form-group row">
		<label id="elh_comprador_rfc" for="x_rfc" class="<?php echo $comprador_edit->LeftColumnClass ?>"><?php echo $comprador->rfc->caption() ?><?php echo ($comprador->rfc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comprador_edit->RightColumnClass ?>"><div<?php echo $comprador->rfc->cellAttributes() ?>>
<?php if (!$comprador->isConfirm()) { ?>
<span id="el_comprador_rfc">
<span<?php echo $comprador->rfc->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($comprador->rfc->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="comprador" data-field="x_rfc" name="x_rfc" id="x_rfc" value="<?php echo HtmlEncode($comprador->rfc->CurrentValue) ?>">
<?php } else { ?>
<span id="el_comprador_rfc">
<span<?php echo $comprador->rfc->viewAttributes() ?>>
...
<?php if ($comprador->calle->Visible) { // calle ?>
	<div id="r_calle" class="form-group row">
		<label id="elh_comprador_calle" for="x_calle" class="<?php echo $comprador_edit->LeftColumnClass ?>"><?php echo $comprador->calle->caption() ?><?php echo ($comprador->calle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comprador_edit->RightColumnClass ?>"><div<?php echo $comprador->calle->cellAttributes() ?>>
<?php if (!$comprador->isConfirm()) { ?>
...
<?php if ($comprador->colonia->Visible) { // colonia ?>
	<div id="r_colonia" class="form-group row">
		<label id="elh_comprador_colonia" for="x_colonia" class="<?php echo $comprador_edit->LeftColumnClass ?>"><?php echo $comprador->colonia->caption() ?><?php echo ($comprador->colonia->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comprador_edit->RightColumnClass ?>"><div<?php echo $comprador->colonia->cellAttributes() ?>>
<?php if (!$comprador->isConfirm()) { ?>
...
<?php if ($comprador->codpostal->Visible) { // codpostal ?>
	<div id="r_codpostal" class="form-group row">
		<label id="elh_comprador_codpostal" for="x_codpostal" class="<?php echo $comprador_edit->LeftColumnClass ?>"><?php echo $comprador->codpostal->caption() ?><?php echo ($comprador->codpostal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comprador_edit->RightColumnClass ?>"><div<?php echo $comprador->codpostal->cellAttributes() ?>>
<?php if (!$comprador->isConfirm()) { ?>
...
<?php if ($comprador->ciudad->Visible) { // ciudad ?>
	<div id="r_ciudad" class="form-group row">
		<label id="elh_comprador_ciudad" for="x_ciudad" class="<?php echo $comprador_edit->LeftColumnClass ?>"><?php echo $comprador->ciudad->caption() ?><?php echo ($comprador->ciudad->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comprador_edit->RightColumnClass ?>"><div<?php echo $comprador->ciudad->cellAttributes() ?>>
<?php if (!$comprador->isConfirm()) { ?>
...
<?php if ($comprador->telefono->Visible) { // telefono ?>
	<div id="r_telefono" class="form-group row">
		<label id="elh_comprador_telefono" for="x_telefono" class="<?php echo $comprador_edit->LeftColumnClass ?>"><?php echo $comprador->telefono->caption() ?><?php echo ($comprador->telefono->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comprador_edit->RightColumnClass ?>"><div<?php echo $comprador->telefono->cellAttributes() ?>>
<?php if (!$comprador->isConfirm()) { ?>
...
<?php if ($comprador->correo->Visible) { // correo ?>
	<div id="r_correo" class="form-group row">
		<label id="elh_comprador_correo" for="x_correo" class="<?php echo $comprador_edit->LeftColumnClass ?>"><?php echo $comprador->correo->caption() ?><?php echo ($comprador->correo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comprador_edit->RightColumnClass ?>"><div<?php echo $comprador->correo->cellAttributes() ?>>
<?php if (!$comprador->isConfirm()) { ?>
...
<?php if ($comprador->pymerfc->Visible) { // pymerfc ?>
	<div id="r_pymerfc" class="form-group row">
		<label id="elh_comprador_pymerfc" class="<?php echo $comprador_edit->LeftColumnClass ?>"><?php echo $comprador->pymerfc->caption() ?><?php echo ($comprador->pymerfc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $comprador_edit->RightColumnClass ?>"><div<?php echo $comprador->pymerfc->cellAttributes() ?>>
<?php if (!$comprador->isConfirm()) { ?>
...
<script>
fcompradoredit.createAutoSuggest({"id":"x_pymerfc","forceSelect":false});
</script>
...
<?php if (!$comprador_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $comprador_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<?php if ($comprador->UpdateConflict == "U") { // Record already updated by other user ?>
...
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $comprador_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
