...
// Create page object
$Facturas_Pyme_add = new Facturas_Pyme_add();

// Run the page
$Facturas_Pyme_add->run();
...
var fFacturas_Pymeadd = currentForm = new ew.Form("fFacturas_Pymeadd", "add");

// Validate form
fFacturas_Pymeadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($Facturas_Pyme_add->rfcfactura->Required) { ?>
		...
		<?php } ?>
		<?php if ($Facturas_Pyme_add->idfactura->Required) { ?>
		...
		<?php if ($Facturas_Pyme_add->monto->Required) { ?>
		...
		<?php if ($Facturas_Pyme_add->estado_operacion->Required) { ?>
		...
		<?php if ($Facturas_Pyme_add->pymerfc->Required) { ?>
		...
		<?php } ?>
		<?php if ($Facturas_Pyme_add->compradorfc->Required) { ?>
		...
		<?php } ?>
		<?php if ($Facturas_Pyme_add->cadena->Required) { ?>
		...
		<?php } ?>
		<?php if ($Facturas_Pyme_add->vencimiento->Required) { ?>
		...
		<?php if ($Facturas_Pyme_add->fondeadorfactura->Required) { ?>
		...
		<?php if ($Facturas_Pyme_add->factura->Required) { ?>
		...
		<?php } ?>
		<?php if ($Facturas_Pyme_add->estatusfactura->Required) { ?>
		...
		<?php if ($Facturas_Pyme_add->compradorid_comprador->Required) { ?>
		...
		<?php if ($Facturas_Pyme_add->fondeadorfacturaidfondeadorfact->Required) { ?>
...
fFacturas_Pymeadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fFacturas_Pymeadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $Facturas_Pyme_add->showPageHeader(); ?>
<?php
$Facturas_Pyme_add->showMessage();
?>
<form name="fFacturas_Pymeadd" id="fFacturas_Pymeadd" class="<?php echo $Facturas_Pyme_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($Facturas_Pyme_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $Facturas_Pyme_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="Facturas_Pyme">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$Facturas_Pyme_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($Facturas_Pyme->rfcfactura->Visible) { // rfcfactura ?>
	<div id="r_rfcfactura" class="form-group row">
		<label id="elh_Facturas_Pyme_rfcfactura" for="x_rfcfactura" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->rfcfactura->caption() ?><?php echo ($Facturas_Pyme->rfcfactura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->rfcfactura->cellAttributes() ?>>
<span id="el_Facturas_Pyme_rfcfactura">
<input type="text" data-table="Facturas_Pyme" data-field="x_rfcfactura" name="x_rfcfactura" id="x_rfcfactura" size="30" maxlength="13" placeholder="<?php echo HtmlEncode($Facturas_Pyme->rfcfactura->getPlaceHolder()) ?>" value="<?php echo $Facturas_Pyme->rfcfactura->EditValue ?>"<?php echo $Facturas_Pyme->rfcfactura->editAttributes() ?>>
</span>
...
<?php if ($Facturas_Pyme->idfactura->Visible) { // idfactura ?>
	<div id="r_idfactura" class="form-group row">
		<label id="elh_Facturas_Pyme_idfactura" for="x_idfactura" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->idfactura->caption() ?><?php echo ($Facturas_Pyme->idfactura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->idfactura->cellAttributes() ?>>
<span id="el_Facturas_Pyme_idfactura">
<input type="text" data-table="Facturas_Pyme" data-field="x_idfactura" name="x_idfactura" id="x_idfactura" size="30" placeholder="<?php echo HtmlEncode($Facturas_Pyme->idfactura->getPlaceHolder()) ?>" value="<?php echo $Facturas_Pyme->idfactura->EditValue ?>"<?php echo $Facturas_Pyme->idfactura->editAttributes() ?>>
</span>
...
<?php if ($Facturas_Pyme->monto->Visible) { // monto ?>
	<div id="r_monto" class="form-group row">
		<label id="elh_Facturas_Pyme_monto" for="x_monto" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->monto->caption() ?><?php echo ($Facturas_Pyme->monto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->monto->cellAttributes() ?>>
...
<?php if ($Facturas_Pyme->estado_operacion->Visible) { // estado_operacion ?>
	<div id="r_estado_operacion" class="form-group row">
		<label id="elh_Facturas_Pyme_estado_operacion" for="x_estado_operacion" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->estado_operacion->caption() ?><?php echo ($Facturas_Pyme->estado_operacion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->estado_operacion->cellAttributes() ?>>
...
<?php if ($Facturas_Pyme->pymerfc->Visible) { // pymerfc ?>
	<div id="r_pymerfc" class="form-group row">
		<label id="elh_Facturas_Pyme_pymerfc" for="x_pymerfc" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->pymerfc->caption() ?><?php echo ($Facturas_Pyme->pymerfc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->pymerfc->cellAttributes() ?>>
...
<?php if ($Facturas_Pyme->compradorfc->Visible) { // compradorfc ?>
	<div id="r_compradorfc" class="form-group row">
		<label id="elh_Facturas_Pyme_compradorfc" for="x_compradorfc" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->compradorfc->caption() ?><?php echo ($Facturas_Pyme->compradorfc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->compradorfc->cellAttributes() ?>>
...
<?php if ($Facturas_Pyme->cadena->Visible) { // cadena ?>
	<div id="r_cadena" class="form-group row">
		<label id="elh_Facturas_Pyme_cadena" for="x_cadena" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->cadena->caption() ?><?php echo ($Facturas_Pyme->cadena->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->cadena->cellAttributes() ?>>
...
<?php if ($Facturas_Pyme->vencimiento->Visible) { // vencimiento ?>
	<div id="r_vencimiento" class="form-group row">
		<label id="elh_Facturas_Pyme_vencimiento" for="x_vencimiento" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->vencimiento->caption() ?><?php echo ($Facturas_Pyme->vencimiento->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->vencimiento->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fFacturas_Pymeadd", "x_vencimiento", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($Facturas_Pyme->fondeadorfactura->Visible) { // fondeadorfactura ?>
	<div id="r_fondeadorfactura" class="form-group row">
		<label id="elh_Facturas_Pyme_fondeadorfactura" for="x_fondeadorfactura" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->fondeadorfactura->caption() ?><?php echo ($Facturas_Pyme->fondeadorfactura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->fondeadorfactura->cellAttributes() ?>>
...
<?php if ($Facturas_Pyme->factura->Visible) { // factura ?>
	<div id="r_factura" class="form-group row">
		<label id="elh_Facturas_Pyme_factura" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->factura->caption() ?><?php echo ($Facturas_Pyme->factura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->factura->cellAttributes() ?>>
...
<?php if ($Facturas_Pyme->estatusfactura->Visible) { // estatusfactura ?>
	<div id="r_estatusfactura" class="form-group row">
		<label id="elh_Facturas_Pyme_estatusfactura" for="x_estatusfactura" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->estatusfactura->caption() ?><?php echo ($Facturas_Pyme->estatusfactura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->estatusfactura->cellAttributes() ?>>
...
<?php if ($Facturas_Pyme->compradorid_comprador->Visible) { // compradorid_comprador ?>
	<div id="r_compradorid_comprador" class="form-group row">
		<label id="elh_Facturas_Pyme_compradorid_comprador" for="x_compradorid_comprador" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->compradorid_comprador->caption() ?><?php echo ($Facturas_Pyme->compradorid_comprador->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->compradorid_comprador->cellAttributes() ?>>
...
<?php if ($Facturas_Pyme->fondeadorfacturaidfondeadorfact->Visible) { // fondeadorfacturaidfondeadorfact ?>
	<div id="r_fondeadorfacturaidfondeadorfact" class="form-group row">
		<label id="elh_Facturas_Pyme_fondeadorfacturaidfondeadorfact" for="x_fondeadorfacturaidfondeadorfact" class="<?php echo $Facturas_Pyme_add->LeftColumnClass ?>"><?php echo $Facturas_Pyme->fondeadorfacturaidfondeadorfact->caption() ?><?php echo ($Facturas_Pyme->fondeadorfacturaidfondeadorfact->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $Facturas_Pyme_add->RightColumnClass ?>"><div<?php echo $Facturas_Pyme->fondeadorfacturaidfondeadorfact->cellAttributes() ?>>
...
<?php if (!$Facturas_Pyme_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $Facturas_Pyme_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $Facturas_Pyme_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$Facturas_Pyme_add->showPageFooter();
if (DEBUG_ENABLED)
