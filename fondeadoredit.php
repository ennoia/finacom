...
// Create page object
$fondeador_edit = new fondeador_edit();
...
var ffondeadoredit = currentForm = new ew.Form("ffondeadoredit", "edit");

// Validate form
ffondeadoredit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($fondeador_edit->id_fondeador->Required) { ?>
		...
		<?php if ($fondeador_edit->rfcfondeador->Required) { ?>
		...
		<?php } ?>
		<?php if ($fondeador_edit->razon_social->Required) { ?>
		...
		<?php } ?>
		<?php if ($fondeador_edit->calle->Required) { ?>
		...
		<?php } ?>
		<?php if ($fondeador_edit->colonia->Required) { ?>
		...
		<?php if ($fondeador_edit->ciudad->Required) { ?>
		...
		<?php } ?>
		<?php if ($fondeador_edit->codpostal->Required) { ?>
		...
		<?php if ($fondeador_edit->telefono->Required) { ?>
		...
		<?php } ?>
		<?php if ($fondeador_edit->correo->Required) { ?>
		...
		<?php } ?>
		<?php if ($fondeador_edit->pais->Required) { ?>
		...
		<?php if ($fondeador_edit->fondeadorfactura->Required) { ?>
		...
		<?php if ($fondeador_edit->calificacion->Required) { ?>
		...
		<?php if ($fondeador_edit->cedooperacionfondeador->Required) { ?>
		...
		<?php if ($fondeador_edit->pymerfc->Required) { ?>
...
ffondeadoredit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ffondeadoredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $fondeador_edit->showPageHeader(); ?>
<?php
$fondeador_edit->showMessage();
?>
<form name="ffondeadoredit" id="ffondeadoredit" class="<?php echo $fondeador_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($fondeador_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $fondeador_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="fondeador">
<input type="hidden" name="k_hash" id="k_hash" value="<?php echo $fondeador_edit->HashValue ?>">
<?php if ($fondeador->UpdateConflict == "U") { // Record already updated by other user ?>
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo (int)$fondeador_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($fondeador->id_fondeador->Visible) { // id_fondeador ?>
	<div id="r_id_fondeador" class="form-group row">
		<label id="elh_fondeador_id_fondeador" for="x_id_fondeador" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->id_fondeador->caption() ?><?php echo ($fondeador->id_fondeador->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->id_fondeador->cellAttributes() ?>>
...
<?php if ($fondeador->rfcfondeador->Visible) { // rfcfondeador ?>
	<div id="r_rfcfondeador" class="form-group row">
		<label id="elh_fondeador_rfcfondeador" for="x_rfcfondeador" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->rfcfondeador->caption() ?><?php echo ($fondeador->rfcfondeador->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->rfcfondeador->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
<span id="el_fondeador_rfcfondeador">
<span<?php echo $fondeador->rfcfondeador->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($fondeador->rfcfondeador->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="fondeador" data-field="x_rfcfondeador" name="x_rfcfondeador" id="x_rfcfondeador" value="<?php echo HtmlEncode($fondeador->rfcfondeador->CurrentValue) ?>">
<?php } else { ?>
<span id="el_fondeador_rfcfondeador">
<span<?php echo $fondeador->rfcfondeador->viewAttributes() ?>>
...
<?php if ($fondeador->razon_social->Visible) { // razon_social ?>
	<div id="r_razon_social" class="form-group row">
		<label id="elh_fondeador_razon_social" for="x_razon_social" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->razon_social->caption() ?><?php echo ($fondeador->razon_social->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->razon_social->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if ($fondeador->calle->Visible) { // calle ?>
	<div id="r_calle" class="form-group row">
		<label id="elh_fondeador_calle" for="x_calle" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->calle->caption() ?><?php echo ($fondeador->calle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->calle->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if ($fondeador->colonia->Visible) { // colonia ?>
	<div id="r_colonia" class="form-group row">
		<label id="elh_fondeador_colonia" for="x_colonia" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->colonia->caption() ?><?php echo ($fondeador->colonia->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->colonia->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if ($fondeador->ciudad->Visible) { // ciudad ?>
	<div id="r_ciudad" class="form-group row">
		<label id="elh_fondeador_ciudad" for="x_ciudad" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->ciudad->caption() ?><?php echo ($fondeador->ciudad->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->ciudad->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if ($fondeador->codpostal->Visible) { // codpostal ?>
	<div id="r_codpostal" class="form-group row">
		<label id="elh_fondeador_codpostal" for="x_codpostal" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->codpostal->caption() ?><?php echo ($fondeador->codpostal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->codpostal->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if ($fondeador->telefono->Visible) { // telefono ?>
	<div id="r_telefono" class="form-group row">
		<label id="elh_fondeador_telefono" for="x_telefono" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->telefono->caption() ?><?php echo ($fondeador->telefono->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->telefono->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if ($fondeador->correo->Visible) { // correo ?>
	<div id="r_correo" class="form-group row">
		<label id="elh_fondeador_correo" for="x_correo" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->correo->caption() ?><?php echo ($fondeador->correo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->correo->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if ($fondeador->pais->Visible) { // pais ?>
	<div id="r_pais" class="form-group row">
		<label id="elh_fondeador_pais" for="x_pais" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->pais->caption() ?><?php echo ($fondeador->pais->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->pais->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if ($fondeador->fondeadorfactura->Visible) { // fondeadorfactura ?>
	<div id="r_fondeadorfactura" class="form-group row">
		<label id="elh_fondeador_fondeadorfactura" for="x_fondeadorfactura" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->fondeadorfactura->caption() ?><?php echo ($fondeador->fondeadorfactura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->fondeadorfactura->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if ($fondeador->calificacion->Visible) { // calificacion ?>
	<div id="r_calificacion" class="form-group row">
		<label id="elh_fondeador_calificacion" for="x_calificacion" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->calificacion->caption() ?><?php echo ($fondeador->calificacion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->calificacion->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if ($fondeador->cedooperacionfondeador->Visible) { // cedooperacionfondeador ?>
	<div id="r_cedooperacionfondeador" class="form-group row">
		<label id="elh_fondeador_cedooperacionfondeador" for="x_cedooperacionfondeador" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->cedooperacionfondeador->caption() ?><?php echo ($fondeador->cedooperacionfondeador->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->cedooperacionfondeador->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if ($fondeador->pymerfc->Visible) { // pymerfc ?>
	<div id="r_pymerfc" class="form-group row">
		<label id="elh_fondeador_pymerfc" for="x_pymerfc" class="<?php echo $fondeador_edit->LeftColumnClass ?>"><?php echo $fondeador->pymerfc->caption() ?><?php echo ($fondeador->pymerfc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fondeador_edit->RightColumnClass ?>"><div<?php echo $fondeador->pymerfc->cellAttributes() ?>>
<?php if (!$fondeador->isConfirm()) { ?>
...
<?php if (!$fondeador_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $fondeador_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<?php if ($fondeador->UpdateConflict == "U") { // Record already updated by other user ?>
...
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $fondeador_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
