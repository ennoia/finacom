...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>SmallLogo.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>SmallLogo.ico">
...
<div class="wrapper ew-layout">
	...
	<?php } ?>
		...
		<div class="container-fluid">
<?php } ?>
<div id="Layer1" style="position:static; left:112px; top:32px; width:800px; height:180px; z-index:1">
<p><br><img src="phpimages/SmallLogo.png" width="400" height="120" alt="" title="" align="left" /></br></p>
