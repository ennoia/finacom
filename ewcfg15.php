...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "Finacom"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'CHIa304hw5dI25jf'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/Finacom.css"); // Project stylesheet file name
...
$PROJECT_ID = "{DE7733FD-5E8C-4B2A-908C-9F9564113BFC}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "POSTGRESQL", "host" => "localhost", "port" => 5432, "user" => "postgres", "pass" => "Qservic2", "db" => "finacom", "schema" => "public", "qs" => "\"", "qe" => "\"");
$CONNECTIONS[0] = &$CONNECTIONS["DB"];
$CONNECTIONS["finacom1"] = array("conn" => NULL, "id" => "finacom1", "type" => "POSTGRESQL", "host" => "localhost", "port" => 5432, "user" => "postgres", "pass" => "Qservic2", "db" => "finacom", "schema" => "public", "qs" => "\"", "qe" => "\"");
$CONNECTIONS[1] = &$CONNECTIONS["finacom1"];
...
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "finacom"); // Administrator password
...
define(PROJECT_NAMESPACE . "USER_LEVEL_FIELD_NAME", "IDuser");
define(PROJECT_NAMESPACE . "USER_PROFILE_FIELD_NAME", "memo");
define(PROJECT_NAMESPACE . "REGISTER_ACTIVATE_FIELD_NAME", "active");
...
define(PROJECT_NAMESPACE . "USER_ACTIVATE_FILTER", "(\"active\" = true)");
...
define(PROJECT_NAMESPACE . "USER_PROFILE_SESSION_TIMEOUT", 2);
...
define(PROJECT_NAMESPACE . "USER_PROFILE_RETRY_LOCKOUT", 1);
...
define(PROJECT_NAMESPACE . "SENDER_EMAIL", "gmail.com"); // Sender email address
define(PROJECT_NAMESPACE . "RECIPIENT_EMAIL", "qservice2009@gmail.com"); // Recipient email address
...
define(PROJECT_NAMESPACE . "UPLOAD_DEST_PATH", "preafiliacion/"); // Upload destination path (relative to app root)
