...
<input type="hidden" name="k_hash" id="k_hash" value="<?php echo $audittrail_edit->HashValue ?>">
<?php if ($audittrail->UpdateConflict == "U") { // Record already updated by other user ?>
<input type="hidden" name="conflict" id="conflict" value="1">
<?php } ?>
<?php if ($audittrail->isConfirm()) { // Confirm page ?>
...
<span id="el_audittrail_id">
<span<?php echo $audittrail->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($audittrail->id->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="audittrail" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($audittrail->id->FormValue) ?>">
<?php } ?>
...
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($audittrail->datetime->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="audittrail" data-field="x_datetime" name="x_datetime" id="x_datetime" value="<?php echo HtmlEncode($audittrail->datetime->FormValue) ?>">
<?php } ?>
...
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($audittrail->script->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="audittrail" data-field="x_script" name="x_script" id="x_script" value="<?php echo HtmlEncode($audittrail->script->FormValue) ?>">
<?php } ?>
...
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($audittrail->user->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="audittrail" data-field="x_user" name="x_user" id="x_user" value="<?php echo HtmlEncode($audittrail->user->FormValue) ?>">
<?php } ?>
...
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($audittrail->_action->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="audittrail" data-field="x__action" name="x__action" id="x__action" value="<?php echo HtmlEncode($audittrail->_action->FormValue) ?>">
<?php } ?>
...
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($audittrail->_table->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="audittrail" data-field="x__table" name="x__table" id="x__table" value="<?php echo HtmlEncode($audittrail->_table->FormValue) ?>">
<?php } ?>
...
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($audittrail->field->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="audittrail" data-field="x_field" name="x_field" id="x_field" value="<?php echo HtmlEncode($audittrail->field->FormValue) ?>">
<?php } ?>
...
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($audittrail->keyvalue->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="audittrail" data-field="x_keyvalue" name="x_keyvalue" id="x_keyvalue" value="<?php echo HtmlEncode($audittrail->keyvalue->FormValue) ?>">
<?php } ?>
...
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($audittrail->oldvalue->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="audittrail" data-field="x_oldvalue" name="x_oldvalue" id="x_oldvalue" value="<?php echo HtmlEncode($audittrail->oldvalue->FormValue) ?>">
<?php } ?>
...
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($audittrail->newvalue->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="audittrail" data-field="x_newvalue" name="x_newvalue" id="x_newvalue" value="<?php echo HtmlEncode($audittrail->newvalue->FormValue) ?>">
<?php } ?>
