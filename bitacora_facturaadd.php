...
// Create page object
$bitacora_factura_add = new bitacora_factura_add();

// Run the page
$bitacora_factura_add->run();
...
$bitacora_factura_add->Page_Render();
?>
...
var fbitacora_facturaadd = currentForm = new ew.Form("fbitacora_facturaadd", "add");

// Validate form
fbitacora_facturaadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($bitacora_factura_add->idfregfactura->Required) { ?>
		...
		<?php } ?>
		<?php if ($bitacora_factura_add->ofertacomision->Required) { ?>
		...
		<?php } ?>
		<?php if ($bitacora_factura_add->fecha_movimiento->Required) { ?>
		...
		<?php if ($bitacora_factura_add->fondeadore->Required) { ?>
		...
		<?php if ($bitacora_factura_add->movimiento->Required) { ?>
		...
		<?php if ($bitacora_factura_add->oferta->Required) { ?>
		...
		<?php if ($bitacora_factura_add->factrfc_idfac->Required) { ?>
		...
		<?php } ?>
		<?php if ($bitacora_factura_add->Column->Required) { ?>
...
fbitacora_facturaadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fbitacora_facturaadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $bitacora_factura_add->showPageHeader(); ?>
<?php
$bitacora_factura_add->showMessage();
?>
<form name="fbitacora_facturaadd" id="fbitacora_facturaadd" class="<?php echo $bitacora_factura_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($bitacora_factura_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $bitacora_factura_add->Token ?>">
<?php } ?>
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo (int)$bitacora_factura_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($bitacora_factura->idfregfactura->Visible) { // idfregfactura ?>
	<div id="r_idfregfactura" class="form-group row">
		<label id="elh_bitacora_factura_idfregfactura" for="x_idfregfactura" class="<?php echo $bitacora_factura_add->LeftColumnClass ?>"><?php echo $bitacora_factura->idfregfactura->caption() ?><?php echo ($bitacora_factura->idfregfactura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $bitacora_factura_add->RightColumnClass ?>"><div<?php echo $bitacora_factura->idfregfactura->cellAttributes() ?>>
...
<?php if ($bitacora_factura->ofertacomision->Visible) { // ofertacomision ?>
	<div id="r_ofertacomision" class="form-group row">
		<label id="elh_bitacora_factura_ofertacomision" for="x_ofertacomision" class="<?php echo $bitacora_factura_add->LeftColumnClass ?>"><?php echo $bitacora_factura->ofertacomision->caption() ?><?php echo ($bitacora_factura->ofertacomision->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $bitacora_factura_add->RightColumnClass ?>"><div<?php echo $bitacora_factura->ofertacomision->cellAttributes() ?>>
<?php if (!$bitacora_factura->isConfirm()) { ?>
...
<?php if ($bitacora_factura->fecha_movimiento->Visible) { // fecha_movimiento ?>
	<div id="r_fecha_movimiento" class="form-group row">
		<label id="elh_bitacora_factura_fecha_movimiento" for="x_fecha_movimiento" class="<?php echo $bitacora_factura_add->LeftColumnClass ?>"><?php echo $bitacora_factura->fecha_movimiento->caption() ?><?php echo ($bitacora_factura->fecha_movimiento->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $bitacora_factura_add->RightColumnClass ?>"><div<?php echo $bitacora_factura->fecha_movimiento->cellAttributes() ?>>
<?php if (!$bitacora_factura->isConfirm()) { ?>
...
<script>
ew.createDateTimePicker("fbitacora_facturaadd", "x_fecha_movimiento", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
<?php } else { ?>
...
<?php if ($bitacora_factura->fondeadore->Visible) { // fondeadore ?>
	<div id="r_fondeadore" class="form-group row">
		<label id="elh_bitacora_factura_fondeadore" for="x_fondeadore" class="<?php echo $bitacora_factura_add->LeftColumnClass ?>"><?php echo $bitacora_factura->fondeadore->caption() ?><?php echo ($bitacora_factura->fondeadore->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $bitacora_factura_add->RightColumnClass ?>"><div<?php echo $bitacora_factura->fondeadore->cellAttributes() ?>>
<?php if (!$bitacora_factura->isConfirm()) { ?>
...
<?php if ($bitacora_factura->movimiento->Visible) { // movimiento ?>
	<div id="r_movimiento" class="form-group row">
		<label id="elh_bitacora_factura_movimiento" for="x_movimiento" class="<?php echo $bitacora_factura_add->LeftColumnClass ?>"><?php echo $bitacora_factura->movimiento->caption() ?><?php echo ($bitacora_factura->movimiento->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $bitacora_factura_add->RightColumnClass ?>"><div<?php echo $bitacora_factura->movimiento->cellAttributes() ?>>
<?php if (!$bitacora_factura->isConfirm()) { ?>
...
<?php if ($bitacora_factura->oferta->Visible) { // oferta ?>
	<div id="r_oferta" class="form-group row">
		<label id="elh_bitacora_factura_oferta" for="x_oferta" class="<?php echo $bitacora_factura_add->LeftColumnClass ?>"><?php echo $bitacora_factura->oferta->caption() ?><?php echo ($bitacora_factura->oferta->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $bitacora_factura_add->RightColumnClass ?>"><div<?php echo $bitacora_factura->oferta->cellAttributes() ?>>
<?php if (!$bitacora_factura->isConfirm()) { ?>
...
<?php if ($bitacora_factura->factrfc_idfac->Visible) { // factrfc_idfac ?>
	<div id="r_factrfc_idfac" class="form-group row">
		<label id="elh_bitacora_factura_factrfc_idfac" for="x_factrfc_idfac" class="<?php echo $bitacora_factura_add->LeftColumnClass ?>"><?php echo $bitacora_factura->factrfc_idfac->caption() ?><?php echo ($bitacora_factura->factrfc_idfac->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $bitacora_factura_add->RightColumnClass ?>"><div<?php echo $bitacora_factura->factrfc_idfac->cellAttributes() ?>>
<?php if (!$bitacora_factura->isConfirm()) { ?>
...
<?php if ($bitacora_factura->Column->Visible) { // Column ?>
	<div id="r_Column" class="form-group row">
		<label id="elh_bitacora_factura_Column" for="x_Column" class="<?php echo $bitacora_factura_add->LeftColumnClass ?>"><?php echo $bitacora_factura->Column->caption() ?><?php echo ($bitacora_factura->Column->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $bitacora_factura_add->RightColumnClass ?>"><div<?php echo $bitacora_factura->Column->cellAttributes() ?>>
<?php if (!$bitacora_factura->isConfirm()) { ?>
...
<?php if (!$bitacora_factura_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $bitacora_factura_add->OffsetColumnClass ?>"><!-- buttons offset -->
<?php if (!$bitacora_factura->isConfirm()) { // Confirm page ?>
...
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $bitacora_factura_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
...
<?php
$bitacora_factura_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$bitacora_factura_add->terminate();
?>