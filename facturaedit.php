...
ffacturaedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($factura_edit->rfcfactura->Required) { ?>
		...
		<?php } ?>
		<?php if ($factura_edit->idfactura->Required) { ?>
		...
		<?php if ($factura_edit->monto->Required) { ?>
		...
		<?php if ($factura_edit->estado_operacion->Required) { ?>
		...
		<?php if ($factura_edit->pymerfc->Required) { ?>
		...
		<?php } ?>
		<?php if ($factura_edit->compradorfc->Required) { ?>
		...
		<?php } ?>
		<?php if ($factura_edit->cadena->Required) { ?>
		...
		<?php } ?>
		<?php if ($factura_edit->vencimiento->Required) { ?>
		...
		<?php if ($factura_edit->fondeadorfactura->Required) { ?>
		...
		<?php if ($factura_edit->factura->Required) { ?>
		...
		<?php } ?>
		<?php if ($factura_edit->estatusfactura->Required) { ?>
		...
		<?php if ($factura_edit->compradorid_comprador->Required) { ?>
		...
		<?php if ($factura_edit->fondeadorfacturaidfondeadorfact->Required) { ?>
...
<input type="hidden" name="k_hash" id="k_hash" value="<?php echo $factura_edit->HashValue ?>">
<?php if ($factura->UpdateConflict == "U") { // Record already updated by other user ?>
...
<?php if ($factura->rfcfactura->Visible) { // rfcfactura ?>
	<div id="r_rfcfactura" class="form-group row">
		<label id="elh_factura_rfcfactura" for="x_rfcfactura" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->rfcfactura->caption() ?><?php echo ($factura->rfcfactura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->rfcfactura->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
<span id="el_factura_rfcfactura">
<span<?php echo $factura->rfcfactura->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($factura->rfcfactura->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="factura" data-field="x_rfcfactura" name="x_rfcfactura" id="x_rfcfactura" value="<?php echo HtmlEncode($factura->rfcfactura->CurrentValue) ?>">
<?php } else { ?>
<span id="el_factura_rfcfactura">
<span<?php echo $factura->rfcfactura->viewAttributes() ?>>
...
<?php if ($factura->idfactura->Visible) { // idfactura ?>
	<div id="r_idfactura" class="form-group row">
		<label id="elh_factura_idfactura" for="x_idfactura" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->idfactura->caption() ?><?php echo ($factura->idfactura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->idfactura->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
<span id="el_factura_idfactura">
<span<?php echo $factura->idfactura->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($factura->idfactura->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="factura" data-field="x_idfactura" name="x_idfactura" id="x_idfactura" value="<?php echo HtmlEncode($factura->idfactura->CurrentValue) ?>">
<?php } else { ?>
<span id="el_factura_idfactura">
<span<?php echo $factura->idfactura->viewAttributes() ?>>
...
<?php if ($factura->monto->Visible) { // monto ?>
	<div id="r_monto" class="form-group row">
		<label id="elh_factura_monto" for="x_monto" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->monto->caption() ?><?php echo ($factura->monto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->monto->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
...
<?php if ($factura->estado_operacion->Visible) { // estado_operacion ?>
	<div id="r_estado_operacion" class="form-group row">
		<label id="elh_factura_estado_operacion" for="x_estado_operacion" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->estado_operacion->caption() ?><?php echo ($factura->estado_operacion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->estado_operacion->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
...
<?php if ($factura->pymerfc->Visible) { // pymerfc ?>
	<div id="r_pymerfc" class="form-group row">
		<label id="elh_factura_pymerfc" for="x_pymerfc" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->pymerfc->caption() ?><?php echo ($factura->pymerfc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->pymerfc->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
...
<?php if ($factura->compradorfc->Visible) { // compradorfc ?>
	<div id="r_compradorfc" class="form-group row">
		<label id="elh_factura_compradorfc" for="x_compradorfc" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->compradorfc->caption() ?><?php echo ($factura->compradorfc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->compradorfc->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
...
<?php if ($factura->cadena->Visible) { // cadena ?>
	<div id="r_cadena" class="form-group row">
		<label id="elh_factura_cadena" for="x_cadena" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->cadena->caption() ?><?php echo ($factura->cadena->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->cadena->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
...
<?php if ($factura->vencimiento->Visible) { // vencimiento ?>
	<div id="r_vencimiento" class="form-group row">
		<label id="elh_factura_vencimiento" for="x_vencimiento" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->vencimiento->caption() ?><?php echo ($factura->vencimiento->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->vencimiento->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
...
<script>
ew.createDateTimePicker("ffacturaedit", "x_vencimiento", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
<?php } else { ?>
...
<?php if ($factura->fondeadorfactura->Visible) { // fondeadorfactura ?>
	<div id="r_fondeadorfactura" class="form-group row">
		<label id="elh_factura_fondeadorfactura" for="x_fondeadorfactura" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->fondeadorfactura->caption() ?><?php echo ($factura->fondeadorfactura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->fondeadorfactura->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
...
<?php if ($factura->factura->Visible) { // factura ?>
	<div id="r_factura" class="form-group row">
		<label id="elh_factura_factura" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->factura->caption() ?><?php echo ($factura->factura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->factura->cellAttributes() ?>>
...
<?php if ($factura->estatusfactura->Visible) { // estatusfactura ?>
	<div id="r_estatusfactura" class="form-group row">
		<label id="elh_factura_estatusfactura" for="x_estatusfactura" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->estatusfactura->caption() ?><?php echo ($factura->estatusfactura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->estatusfactura->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
...
<?php if ($factura->compradorid_comprador->Visible) { // compradorid_comprador ?>
	<div id="r_compradorid_comprador" class="form-group row">
		<label id="elh_factura_compradorid_comprador" for="x_compradorid_comprador" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->compradorid_comprador->caption() ?><?php echo ($factura->compradorid_comprador->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->compradorid_comprador->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
...
<?php if ($factura->fondeadorfacturaidfondeadorfact->Visible) { // fondeadorfacturaidfondeadorfact ?>
	<div id="r_fondeadorfacturaidfondeadorfact" class="form-group row">
		<label id="elh_factura_fondeadorfacturaidfondeadorfact" for="x_fondeadorfacturaidfondeadorfact" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->fondeadorfacturaidfondeadorfact->caption() ?><?php echo ($factura->fondeadorfacturaidfondeadorfact->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->fondeadorfacturaidfondeadorfact->cellAttributes() ?>>
<?php if (!$factura->isConfirm()) { ?>
