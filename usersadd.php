...
fusersadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($users_add->IDuser->Required) { ?>
		...
		<?php } ?>
		<?php if ($users_add->user->Required) { ?>
		...
		<?php } ?>
		<?php if ($users_add->correo->Required) { ?>
		...
		<?php } ?>
		<?php if ($users_add->active->Required) { ?>
		...
		<?php } ?>
		<?php if ($users_add->userlevel->Required) { ?>
		...
		<?php } ?>
		<?php if ($users_add->memo->Required) { ?>
...
fusersadd.lists["x_IDuser"] = <?php echo $users_add->IDuser->Lookup->toClientList() ?>;
fusersadd.lists["x_IDuser"].options = <?php echo JsonEncode($users_add->IDuser->lookupOptions()) ?>;
fusersadd.lists["x_active[]"] = <?php echo $users_add->active->Lookup->toClientList() ?>;
fusersadd.lists["x_active[]"].options = <?php echo JsonEncode($users_add->active->options(FALSE, TRUE)) ?>;
fusersadd.lists["x_userlevel"] = <?php echo $users_add->userlevel->Lookup->toClientList() ?>;
fusersadd.lists["x_userlevel"].options = <?php echo JsonEncode($users_add->userlevel->lookupOptions()) ?>;
...
<?php if ($users->IDuser->Visible) { // IDuser ?>
	<div id="r_IDuser" class="form-group row">
		<label id="elh_users_IDuser" for="x_IDuser" class="<?php echo $users_add->LeftColumnClass ?>"><?php echo $users->IDuser->caption() ?><?php echo ($users->IDuser->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_add->RightColumnClass ?>"><div<?php echo $users->IDuser->cellAttributes() ?>>
...
<div class="input-group ew-lookup-list">
	<div class="form-control ew-lookup-text" tabindex="-1" id="lu_x_IDuser"><?php echo strval($users->IDuser->ViewValue) == "" ? $Language->phrase("PleaseSelect") : $users->IDuser->ViewValue ?></div>
...
<input type="hidden" data-table="users" data-field="x_IDuser" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $users->IDuser->displayValueSeparatorAttribute() ?>" name="x_IDuser" id="x_IDuser" value="<?php echo $users->IDuser->CurrentValue ?>"<?php echo $users->IDuser->editAttributes() ?>>
</span>
<?php } ?>
<?php } else { ?>
<span id="el_users_IDuser">
...
<?php if ($users->user->Visible) { // user ?>
	<div id="r_user" class="form-group row">
		<label id="elh_users_user" for="x_user" class="<?php echo $users_add->LeftColumnClass ?>"><?php echo $users->user->caption() ?><?php echo ($users->user->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_add->RightColumnClass ?>"><div<?php echo $users->user->cellAttributes() ?>>
<?php if (!$users->isConfirm()) { ?>
...
<?php if ($users->correo->Visible) { // correo ?>
	<div id="r_correo" class="form-group row">
		<label id="elh_users_correo" for="x_correo" class="<?php echo $users_add->LeftColumnClass ?>"><?php echo $users->correo->caption() ?><?php echo ($users->correo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_add->RightColumnClass ?>"><div<?php echo $users->correo->cellAttributes() ?>>
<?php if (!$users->isConfirm()) { ?>
...
<?php if ($users->active->Visible) { // active ?>
	<div id="r_active" class="form-group row">
		<label id="elh_users_active" class="<?php echo $users_add->LeftColumnClass ?>"><?php echo $users->active->caption() ?><?php echo ($users->active->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_add->RightColumnClass ?>"><div<?php echo $users->active->cellAttributes() ?>>
<?php if (!$users->isConfirm()) { ?>
...
<?php if ($users->userlevel->Visible) { // userlevel ?>
	<div id="r_userlevel" class="form-group row">
		<label id="elh_users_userlevel" for="x_userlevel" class="<?php echo $users_add->LeftColumnClass ?>"><?php echo $users->userlevel->caption() ?><?php echo ($users->userlevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_add->RightColumnClass ?>"><div<?php echo $users->userlevel->cellAttributes() ?>>
<?php if (!$users->isConfirm()) { ?>
...
<?php if ($users->memo->Visible) { // memo ?>
	<div id="r_memo" class="form-group row">
		<label id="elh_users_memo" for="x_memo" class="<?php echo $users_add->LeftColumnClass ?>"><?php echo $users->memo->caption() ?><?php echo ($users->memo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $users_add->RightColumnClass ?>"><div<?php echo $users->memo->cellAttributes() ?>>
<?php if (!$users->isConfirm()) { ?>
