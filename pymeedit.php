...
var fpymeedit = currentForm = new ew.Form("fpymeedit", "edit");

// Validate form
fpymeedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($pyme_edit->rfcpyme->Required) { ?>
		...
		<?php } ?>
		<?php if ($pyme_edit->id_pyme->Required) { ?>
		...
		<?php if ($pyme_edit->razon_social->Required) { ?>
		...
		<?php } ?>
		<?php if ($pyme_edit->calle->Required) { ?>
		...
		<?php } ?>
		<?php if ($pyme_edit->colonia->Required) { ?>
		...
		<?php } ?>
		<?php if ($pyme_edit->ciudad->Required) { ?>
		...
		<?php } ?>
		<?php if ($pyme_edit->codpostal->Required) { ?>
		...
		<?php if ($pyme_edit->correo->Required) { ?>
		...
		<?php } ?>
		<?php if ($pyme_edit->telefono->Required) { ?>
		...
		<?php } ?>
		<?php if ($pyme_edit->pais->Required) { ?>
		...
		<?php if ($pyme_edit->contrato_firmado->Required) { ?>
		...
		<?php } ?>
		<?php if ($pyme_edit->preafiliacion->Required) { ?>
		...
		<?php if ($pyme_edit->edooperacionpyme->Required) { ?>
		...
		<?php if ($pyme_edit->compradorrfc->Required) { ?>
		...
		<?php } ?>
		<?php if ($pyme_edit->comprador->Required) { ?>
...
fpymeedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fpymeedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpymeedit.lists["x_compradorrfc"] = <?php echo $pyme_edit->compradorrfc->Lookup->toClientList() ?>;
fpymeedit.lists["x_compradorrfc"].options = <?php echo JsonEncode($pyme_edit->compradorrfc->lookupOptions()) ?>;
fpymeedit.autoSuggests["x_compradorrfc"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php $pyme_edit->showPageHeader(); ?>
<?php
$pyme_edit->showMessage();
?>
<form name="fpymeedit" id="fpymeedit" class="<?php echo $pyme_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($pyme_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pyme_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="pyme">
<input type="hidden" name="k_hash" id="k_hash" value="<?php echo $pyme_edit->HashValue ?>">
<?php if ($pyme->UpdateConflict == "U") { // Record already updated by other user ?>
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo (int)$pyme_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($pyme->rfcpyme->Visible) { // rfcpyme ?>
	<div id="r_rfcpyme" class="form-group row">
		<label id="elh_pyme_rfcpyme" for="x_rfcpyme" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->rfcpyme->caption() ?><?php echo ($pyme->rfcpyme->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->rfcpyme->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
<span id="el_pyme_rfcpyme">
<span<?php echo $pyme->rfcpyme->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($pyme->rfcpyme->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="pyme" data-field="x_rfcpyme" name="x_rfcpyme" id="x_rfcpyme" value="<?php echo HtmlEncode($pyme->rfcpyme->CurrentValue) ?>">
<?php } else { ?>
<span id="el_pyme_rfcpyme">
<span<?php echo $pyme->rfcpyme->viewAttributes() ?>>
...
<?php if ($pyme->id_pyme->Visible) { // id_pyme ?>
	<div id="r_id_pyme" class="form-group row">
		<label id="elh_pyme_id_pyme" for="x_id_pyme" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->id_pyme->caption() ?><?php echo ($pyme->id_pyme->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->id_pyme->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if ($pyme->razon_social->Visible) { // razon_social ?>
	<div id="r_razon_social" class="form-group row">
		<label id="elh_pyme_razon_social" for="x_razon_social" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->razon_social->caption() ?><?php echo ($pyme->razon_social->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->razon_social->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if ($pyme->calle->Visible) { // calle ?>
	<div id="r_calle" class="form-group row">
		<label id="elh_pyme_calle" for="x_calle" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->calle->caption() ?><?php echo ($pyme->calle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->calle->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if ($pyme->colonia->Visible) { // colonia ?>
	<div id="r_colonia" class="form-group row">
		<label id="elh_pyme_colonia" for="x_colonia" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->colonia->caption() ?><?php echo ($pyme->colonia->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->colonia->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if ($pyme->ciudad->Visible) { // ciudad ?>
	<div id="r_ciudad" class="form-group row">
		<label id="elh_pyme_ciudad" for="x_ciudad" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->ciudad->caption() ?><?php echo ($pyme->ciudad->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->ciudad->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if ($pyme->codpostal->Visible) { // codpostal ?>
	<div id="r_codpostal" class="form-group row">
		<label id="elh_pyme_codpostal" for="x_codpostal" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->codpostal->caption() ?><?php echo ($pyme->codpostal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->codpostal->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if ($pyme->correo->Visible) { // correo ?>
	<div id="r_correo" class="form-group row">
		<label id="elh_pyme_correo" for="x_correo" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->correo->caption() ?><?php echo ($pyme->correo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->correo->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if ($pyme->telefono->Visible) { // telefono ?>
	<div id="r_telefono" class="form-group row">
		<label id="elh_pyme_telefono" for="x_telefono" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->telefono->caption() ?><?php echo ($pyme->telefono->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->telefono->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if ($pyme->pais->Visible) { // pais ?>
	<div id="r_pais" class="form-group row">
		<label id="elh_pyme_pais" for="x_pais" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->pais->caption() ?><?php echo ($pyme->pais->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->pais->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if ($pyme->contrato_firmado->Visible) { // contrato_firmado ?>
	<div id="r_contrato_firmado" class="form-group row">
		<label id="elh_pyme_contrato_firmado" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->contrato_firmado->caption() ?><?php echo ($pyme->contrato_firmado->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->contrato_firmado->cellAttributes() ?>>
...
<?php if (Post("fa_x_contrato_firmado") == "0") { ?>
<input type="hidden" name="fa_x_contrato_firmado" id= "fa_x_contrato_firmado" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_contrato_firmado" id= "fa_x_contrato_firmado" value="1">
<?php } ?>
...
<?php if ($pyme->preafiliacion->Visible) { // preafiliacion ?>
	<div id="r_preafiliacion" class="form-group row">
		<label id="elh_pyme_preafiliacion" for="x_preafiliacion" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->preafiliacion->caption() ?><?php echo ($pyme->preafiliacion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->preafiliacion->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if ($pyme->edooperacionpyme->Visible) { // edooperacionpyme ?>
	<div id="r_edooperacionpyme" class="form-group row">
		<label id="elh_pyme_edooperacionpyme" for="x_edooperacionpyme" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->edooperacionpyme->caption() ?><?php echo ($pyme->edooperacionpyme->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->edooperacionpyme->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if ($pyme->compradorrfc->Visible) { // compradorrfc ?>
	<div id="r_compradorrfc" class="form-group row">
		<label id="elh_pyme_compradorrfc" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->compradorrfc->caption() ?><?php echo ($pyme->compradorrfc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->compradorrfc->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<script>
fpymeedit.createAutoSuggest({"id":"x_compradorrfc","forceSelect":false});
</script>
...
<?php if ($pyme->comprador->Visible) { // comprador ?>
	<div id="r_comprador" class="form-group row">
		<label id="elh_pyme_comprador" for="x_comprador" class="<?php echo $pyme_edit->LeftColumnClass ?>"><?php echo $pyme->comprador->caption() ?><?php echo ($pyme->comprador->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pyme_edit->RightColumnClass ?>"><div<?php echo $pyme->comprador->cellAttributes() ?>>
<?php if (!$pyme->isConfirm()) { ?>
...
<?php if (!$pyme_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $pyme_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<?php if ($pyme->UpdateConflict == "U") { // Record already updated by other user ?>
...
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $pyme_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
